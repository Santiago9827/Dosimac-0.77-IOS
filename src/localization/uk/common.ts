...
animalIdNotFound: "Ідентифікатор тварини не знайдено.",
openAnimalInfoError: "Не вдалося відкрити інформацію про тварину.",
  penNotFound: "Станок не знайдено",
...
gestCorralDetail: {
   ...
   operationsButton: "Операції",
   operationsTitle: "Операції",
   operationsSubtitle: "Виберіть операцію",

   operationInseminationDate: "Дата осіменіння",
   operationCurve: "Крива",
   operationBodyCondition: "Вгодованість",
   operationChangePen: "Зміна станка",
   operationExitAnimal: "Вихід тварини",
   operationReplaceEarTag: "Замінити бирку",
   ...
   selectBodyCondition: "Вибрати вгодованість",
   loadingBodyConditions: "Завантаження станів вгодованості...",
   noBodyConditionsAvailable: "Немає доступних станів вгодованості",

   changePenTitle: "Змінити станок",
   currentPen: "Поточний станок: {{corral}}",
   newPen: "Новий станок",
   changePenPlaceholder: "Введіть станок призначення",

   replaceEarTagTitle: "Замінити бирку",
   currentEarTag: "Поточна бирка: {{crotal}}",
   newEarTag: "Нова бирка",
   replaceEarTagPlaceholder: "Введіть нову бирку",

   inseminationDateTitle: "Дата осіменіння",
   selectDate: "Виберіть дату",
   noFutureInseminationDate: "Не можна вибрати дату пізніше поточної.",

   exitAnimalTitle: "Вихід тварини",
   exitAnimalGestation: "Вихід тварини із супоросності",
   exitDate: "Дата виходу",
   noFutureExitDate: "Дата виходу не може бути пізніше поточної дати.",

   penNotFound: "Станок не знайдено",
   changePenGenericError: "Не вдалося змінити станок.",
   earTagAlreadyAssigned: "Бирка призначена іншій тварині",
