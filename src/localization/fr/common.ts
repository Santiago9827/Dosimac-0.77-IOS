export default {
  ...
  colocaQrInstalacionCamara: "Placez le code QR de l’installation dans le cadre de la caméra.",
  escaneaCodigoQr: "Scannez le code QR",
  permisoCamaraNecesario: "Autorisation de caméra requise",
  permisoCamaraQrTexto: "Vous devez autoriser l’accès à la caméra pour scanner le code QR.",
  qrNoValido: "Code QR non valide",
  qrNoEsInstalacionDosimac: "Ce n’est pas un code QR d’installation DOSIMAC.",
  ipAplicadaSinCredenciales: "L’adresse IP a été appliquée correctement, mais cette installation n’a pas de Username ni de mot de passe.",
  instalacionSeleccionada: "Installation sélectionnée",
  conexionExitosa: "Connexion réussie",
  instalacionConectadaCorrectamente: "L’installation s’est connectée correctement.",
  noPuedeConectarInstalacionSeleccionada: "Impossible de se connecter à l’installation sélectionnée. Vérifiez le réseau WiFi ou l’adresse IP du serveur.",
  conectando: "Connexion en cours",
  conectandoInstalacionSeleccionada: "Connexion à l’installation sélectionnée...",
  ...
  generalHome: {
    ...
    tareasMovimientosTitulo: "Tâches de mouvements",
    tareasMovimientosDescripcion: "Consultation et gestion des tâches de mouvements en attente.",
  ...
  tareasMovimientosDetalle: {
    ...
    tarjetas: {
      ...
      corralDestino: "Case de destination",
      corralOrigen: "Case d'origine",
      fecha: "Date programmée",
      fechaRealizado: "Date réalisée",
    },
  ...
  modalSalidaPendiente: {
    titulo: "Sortie en attente",
    mensaje: "Cet animal a une tâche de sortie en attente. Voulez-vous d'abord compléter la sortie, puis réaliser l'entrée sélectionnée ?",
    animal: "Animal",
    botonConfirmar: "Réaliser l'opération",
    trasladoEntradaTitulo: "Transfert d'entrée",
    soloUnTrasladoEntrada: "Vous ne pouvez sélectionner qu'un seul transfert d'entrée à la fois.",
  }
