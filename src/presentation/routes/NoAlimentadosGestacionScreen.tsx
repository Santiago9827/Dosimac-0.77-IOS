...
const STORAGE_NO_ALIMENTADOS_GESTACION =
    '@no_alimentados_gestacion_vistos';
                ...
                <View style={styles.contenedorIdentificacion}>
                    ...
                    <View style={styles.datosIdentificacion}>
                        <Text style={styles.etiquetaIdentificacion}>
                            {t('noAlimentadosGestacion.animalId')}
                        </Text>
                ...
                <View style={styles.cabeceraDerecha}>
                    <View style={styles.chipCorral}>
                        <Text style={styles.textoChipCorral}>
                            {t('noAlimentadosGestacion.corral')} {corral}
                        </Text>
                    </View>
            ...
            <View style={styles.filaInformacion}>
                ...
                >
                    <Text style={styles.etiquetaInformacion}>
                        {t('noAlimentadosGestacion.consumption')}
                    </Text>
                ...
                >
                    ...
                    >
                        {t('noAlimentadosGestacion.withoutFeeding')}
                    </Text>
                    ...
                    >
                        {diasSinAlimentar}{' '}
                        {diasSinAlimentar === 1
                            ? t('noAlimentadosGestacion.day')
                            : t('noAlimentadosGestacion.days')}
                    </Text>
                </View>
            </View>
...
export const NoAlimentadosGestacionScreen = () => {
    ...
    const [
        totalAnimalesGestacion,
        setTotalAnimalesGestacion,
    ] = useState<number | null>(null);
            ...
            try {
                const textoGuardado =
                    await AsyncStorage.getItem(
                        STORAGE_NO_ALIMENTADOS_GESTACION,
                    );
    ...
    const cargarAnimales = useCallback(async () => {
        try {
            const [datos, totalGestacion] =
                await Promise.all([
                    consultarAnimalesNoAlimentadosGestacion(),

                    consultarNumeroAnimalesGestacion().catch(
                        error => {
                            console.log(
                                'Error consultando total de gestación:',
                                error,
                            );
            ...
            console.log(
                'Error cargando animales no alimentados de gestación:',
                error,
            );
            ...
            Alert.alert(
                ...
                error?.message ??
                t('noAlimentadosGestacion.serverConnectionError'),
            );
        } finally {
            setCargando(false);
            setRefrescando(false);
        }
    }, [sincronizarVistosConPosix, t]);
        ...
        return (
            <View style={styles.pantallaCarga}>
                ...
                <Text style={styles.textoCarga}>
                    {t('noAlimentadosGestacion.loadingAnimals')}
                </Text>
            </View>
        );
    }
        ...
        <View style={styles.pantalla}>
            <View style={styles.tarjetaCabecera}>
                <Text style={styles.titulo}>
                    {t('noAlimentadosGestacion.title')}
                </Text>

                {totalAnimalesGestacion !== null && (
                    <View style={styles.tarjetaTotal}>
                        <Text style={styles.etiquetaTotal}>
                            {t('noAlimentadosGestacion.totalAnimalsGestation')}
                        </Text>
                ...
                <View style={styles.filaBotonesCabecera}>
                    ...
                    >
                        ...
                        >
                            {tipoFiltroVistos ===
                                'noMarcados'
                                ? t('noAlimentadosGestacion.notSeen')
                                : t('noAlimentadosGestacion.all')}
                        </Text>
                    </TouchableOpacity>
                    ...
                    >
                        ...
                        <Text
                            style={styles.textoBotonCabecera}
                        >
                            {t('noAlimentadosGestacion.sort')}
                        </Text>
                    </TouchableOpacity>
                </View>
            </View>
                ...
                ListEmptyComponent={
                    <View style={styles.contenedorVacio}>
                        ...
                        <Text style={styles.tituloVacio}>
                            {t('noAlimentadosGestacion.emptyTitle')}
                        </Text>

                        <Text style={styles.textoVacio}>
                            {t('noAlimentadosGestacion.emptyText')}
                        </Text>
                    </View>
                }
                renderItem={({ item }) => {
                ...
                >
                    <Pressable style={styles.menuModal}>
                        <Text style={styles.tituloMenu}>
                            {t('noAlimentadosGestacion.sortBy')}
                        </Text>
                        ...
                        >
                            ...
                            <View style={styles.textosOpcion}>
                                ...
                                >
                                    {t('noAlimentadosGestacion.daysWithoutFeeding')}
                                </Text>

                                <Text
                                    style={styles.ayudaOpcion}
                                >
                                    {t('noAlimentadosGestacion.sortDaysHel')}
                                </Text>
                            </View>
                        ...
                        >
                            ...
                            <View style={styles.textosOpcion}>
                                ...
                                >
                                    {t('noAlimentadosGestacion.corral')}
                                </Text>

                                <Text
                                    style={styles.ayudaOpcion}
                                >
                                    {t('noAlimentadosGestacion.sortCorralHelp')}
                                </Text>
                            </View>
                        ...
                        >
                            ...
                            <Text
                                style={styles.textoDireccion}
                            >
                                {direccionOrden === 'desc'
                                    ? t('noAlimentadosGestacion.descending')
                                    : t('noAlimentadosGestacion.ascending')}
                            </Text>
                        </TouchableOpacity>
                    </Pressable>
                </Pressable>
            ...
            >
                ...
                >
                    <Pressable style={styles.menuModal}>
                        <Text style={styles.tituloMenu}>
                            {t('noAlimentadosGestacion.filterAnimals')}
                        </Text>
                        ...
                        >
                            ...
                            <View style={styles.textosOpcion}>
                                ...
                                <Text
                                    style={styles.ayudaOpcion}
                                >
                                    {t('noAlimentadosGestacion.allHelp')}
                                </Text>
                            </View>
                            ...
                            <View style={styles.textosOpcion}>
                                <Text
                                    style={[
                                        ...
                                        tipoFiltroVistos ===
                                        'noMarcados' &&
                                        styles.textoActivoAzul,
                                    ]}
                                >
                                    {t('noAlimentadosGestacion.unmarked')}
                                </Text>

                                <Text
                                    style={styles.ayudaOpcion}
                                >
                                    {t('noAlimentadosGestacion.unmarkedHelp')}
                                </Text>
                            </View>
            ...
            >
                <View style={styles.fondoModalConfirmacion}>
                    <View style={styles.tarjetaConfirmacion}>
                        ...
                        <Text
                            style={
                                styles.tituloModalConfirmacion
                            }
                        >
                            {t('noAlimentadosGestacion.clearMarkedTitle')}
                        </Text>

                        <Text
                            style={
                                styles.textoModalConfirmacion
                            }
                        >
                            {t('noAlimentadosGestacion.clearMarkedText')}
                        </Text>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    {t('noAlimentadosGestacion.cancel')}
                                </Text>
                            </TouchableOpacity>
                            ...
                            >
                                <Text
                                    style={styles.textoAceptar}
                                >
                                    {t('noAlimentadosGestacion.clear')}
                                </Text>
                            </TouchableOpacity>
                        </View>
                    </View>
